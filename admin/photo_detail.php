...
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <a href="../config/process_like.php?fotoid=<?php echo $data['fotoid'] ?>" class="btn btn-outline-primary me-2">
                        ...
                        <!-- KOMENTAR -->
                        <form action="../config/comment_function.php" method="POST" class="mt-3">
                            <div class="mb-3">
    ...
    <!-- Footer -->
    <footer class="footer">
        <p>&copy; 2024 PhotoVista Gallery | Created by NIGGAS | RPL</p>
    </footer>
