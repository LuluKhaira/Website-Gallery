        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="../config/photo_function_user.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="deskripsifoto" name="deskripsifoto" rows="3"
                                    required></textarea>
                            </div>
                            <div class="mb-3">
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        <div class="col">
                            <div class="card h-100 photo-card">
                                <img src="../assets/img/<?php echo $row['lokasifile'] ?>" class="card-img-top"
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small
                                            class="text-muted"><?php echo $row['tanggalunggah']; ?></small></p>
                                </div>
                                <div class="card-footer bg-transparent">
                                    <a href="../config/function_print.php?fotoid=<?php echo $row['fotoid']; ?>"
                                ...
                                <div class="photo-actions">
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#edit<?php echo $row['fotoid']; ?>">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <form action="../config/photo_function_user.php" method="POST" style="display:inline;">
                        ...
                        <!-- Edit Modal -->
                        <div class="modal fade" id="edit<?php echo $row['fotoid']; ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../config/photo_function_user.php" method="POST"
                                            enctype="multipart/form-data">
                                            <input type="hidden" name="fotoid" value="<?php echo $row['fotoid']; ?>">
                                            <div class="mb-3">
                                                <label class="form-label">Photo Name</label>
                                                <input type="text" name="judulfoto" class="form-control"
                                                    value="<?php echo htmlspecialchars($row['judulfoto']); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Description</label>
                                                <textarea class="form-control" name="deskripsifoto"
                                                    required><?php echo htmlspecialchars($row['deskripsifoto']); ?></textarea>
                                            </div>
                                            <div class="mb-3">
