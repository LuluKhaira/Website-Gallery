...
<body class="bg-gray-100 min-h-screen flex flex-col">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            ?>
                <div onclick="location.href='album_foto.php?albumid=<?php echo $row['albumid']; ?>'"
                    ...
                    <div class="p-6">
                        <h2 class="text-2xl font-semibold mb-3 text-gray-800"><?php echo htmlspecialchars($row['namaalbum']); ?></h2>
                        <p class="text-gray-600 mb-4 line-clamp-3"><?php echo htmlspecialchars($row['deskripsi']); ?></p>
                        <p class="text-sm text-gray-500">Created: <?php echo date('F j, Y', strtotime($row['tanggaldibuat'])); ?></p>
                    </div>
                ...
                <div id="editModal<?php echo $row['albumid']; ?>"
                    ...
                    <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md transform transition-all duration-300 scale-90 opacity-0" id="modalContent<?php echo $row['albumid']; ?>">
                        <h2 class="text-3xl font-bold mb-6 text-gray-800">Edit Album</h2>
                        <form action="../config/album_function_user.php" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="editDescription<?php echo $row['albumid']; ?>" name="deskripsi" rows="4" required
                            ...
                            <div class="flex justify-end space-x-4">
                                ...
                                <button type="submit" name="edit"
                                    class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-300">Save Changes</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div id="createModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md transform transition-all duration-300 scale-90 opacity-0" id="createModalContent">
            ...
            <form action="../config/album_function_user.php" method="POST">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" name="add"
                        class="px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors duration-300">Create Album</button>
                </div>
            </form>
        </div>
    </div>
